...
public class AdminOverviewTest extends BaseAdminTest {
    ...
    public void TC025_admin_overview_ui_and_filters(){
        ...
        assertTrue(admin.isMediConnectHeaderVisible(), "MediConnect header not visible");
        assertTrue(admin.isAdminControlHeaderVisible(), "Admin Control header not visible");
        assertTrue(admin.isOverviewDivisionVisible(), "Overview section not visible");
        assertTrue(admin.isPatientsAndCareDivisionVisible(), "Patients & Care section not visible");
        assertTrue(admin.isOperationsDivisionVisible(), "Operations section not visible");

        assertTrue(admin.navLinksCount()==9,"All the navigation links are not available");
    }

    @Test(groups = {"regression"})
    public void TC026_admin_overview_stat_tiles(){
        AdminOverview admin = new AdminOverview(driver);
        admin.loadContents();
        ...
        assertTrue(admin.validateTotalPatients(), "Invalid Total Patients value");
        assertTrue(admin.validateTotalDoctors(), "Invalid Total Doctors value");
        assertTrue(admin.validateBedOccupancy(), "Invalid Bed Occupancy value");
        assertTrue(admin.validateRevenueValue(), "Invalid Revenue value");
        assertTrue(admin.validateDoctorsOnDuty(), "Invalid Doctors On Duty value");


    }

    @Test(groups = {"regression"})
    public void TC027_admin_overview_charts(){
        AdminOverview admin = new AdminOverview(driver);
        admin.loadContents();
    }

    @Test(groups = {"regression"})
    public void TC028_admin_overview_map_and_ai_insights(){
        AdminOverview admin = new AdminOverview(driver);
        admin.loadContents();
    }

    @Test(groups = {"regression"})
    public void TC029_admin_overview_notifications_and_profile(){
        AdminOverview admin = new AdminOverview(driver);
        admin.loadContents();
